/****************************************************************************
** Meta object code from reading C++ file 'sm2_key_manage.h'
**
...
#include "../../fileE2/sm2_key_manage.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'sm2_key_manage.h' doesn't include <QObject>."
...
const QMetaObject KeyManager::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_KeyManager.data,
      qt_meta_data_KeyManager,  qt_static_metacall, nullptr, nullptr}
};
...
void *KeyManager::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_KeyManager.stringdata0))
        return static_cast<void*>(const_cast< KeyManager*>(this));
